...
public class test {
	...
	public static void main(String[] args) {		
		...
		while(run)
		{
			...
			System.out.println("8 .. vypis vsech knih zanru"); //nefunguje
			...
			System.out.println("12 .. ukonceni aplikace"); //dodelat SQL
			...
			switch(volba)
			{
				case 1:
					...
					typKnihy = sc.next();
					if (typKnihy.equals("roman")) { //pokud je tam roman, tak se dále zeptá na zanr
						System.out.println("Zadejte zanr:");
						zanr = sc.next();
					}
					else if (typKnihy.equals("ucebnice")) { //pokud je tam ucebnice, tak se zeptá na rocnik
